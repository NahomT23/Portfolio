...
const Home = () => {
    ...
    I build high-quality web applications with a focus on both front-end and back-end development. I aim to create easy-to-use solutions with modern technologies.
                    </p>
                    <div>
